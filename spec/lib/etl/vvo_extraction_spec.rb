...
describe Etl::VvoExtraction do
  ...
  it 'should download a document' do
    VCR.use_cassette('etl/vvo_extraction/vvo_2675') do
  ...
  it 'should save extracted information to the database' do
    VCR.use_cassette('etl/vvo_extraction/vvo_185504') do
  ...
  it 'should update the last_processed_id only when something was processed' do
    VCR.use_cassette('etl/vvo_extraction/vvo_185506') do
  ...
  describe 'parsing' do
    ...
    it 'should get price even if it was not finalized' do
      VCR.use_cassette('etl/vvo_extraction/vvo_185583') do
    ...
    it 'should get price even if it was not finalized' do
      VCR.use_cassette('etl/vvo_extraction/vvo_191763') do
    ...
    it 'should get price even if it was not finalized' do
      VCR.use_cassette('etl/vvo_extraction/vvo_186450') do
    ...
    it 'should get price even if it was not finalized' do
      VCR.use_cassette('etl/vvo_extraction/vvo_185892') do
    ...
    it 'should get suppliers information from a document' do
      VCR.use_cassette('etl/vvo_extraction/vvo_192396') do
